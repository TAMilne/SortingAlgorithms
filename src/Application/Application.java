	...
	public static void main(String[] args) {
		...
		for(String arg : args) {
			...
			case 'f':
				...
				if (filePathString.contains("c:\\temp\\")) {
					filePathString.substring(filePathString.lastIndexOf("\\"));
				} else if(!filePathString.contains("res\\")) {
					filePathString = "res\\" + filePathString;
				}
			break;
			case 's':
