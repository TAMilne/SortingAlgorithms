	...
	public void determineSort(String sortType, String sortParameter, Shape[] shapes, String filePathString) {
		...
		case "b": 
				...
				case "v":
					...
					sortedShapes = s.bubbleSort(shapes, new CompareVolume());
				...
				case "h": 
					start = System.currentTimeMillis();
					sortedShapes = s.bubbleSort(shapes, new CompareHeight());
					stop = System.currentTimeMillis();
				...
				case "a": 
					start = System.currentTimeMillis();
					sortedShapes = s.bubbleSort(shapes, new CompareBaseArea());
					stop = System.currentTimeMillis();
		...
		case "i": 
			...
			case "v":
				start = System.currentTimeMillis();
				sortedShapes = s.insertSort(shapes, new CompareVolume());
				stop = System.currentTimeMillis();
			...
			case "h": 
				start = System.currentTimeMillis();
				sortedShapes = s.insertSort(shapes, new CompareHeight());
				stop = System.currentTimeMillis();
			...
			case "a": 
				start = System.currentTimeMillis();
				sortedShapes = s.insertSort(shapes, new CompareBaseArea());
				stop = System.currentTimeMillis();
		...
		case "s": 
			...
			case "v":
				start = System.currentTimeMillis();
				sortedShapes = s.selectionSort(shapes, new CompareVolume());
				stop = System.currentTimeMillis();
			...
			case "h": 
				start = System.currentTimeMillis();
				sortedShapes = s.selectionSort(shapes, new CompareHeight());
				stop = System.currentTimeMillis();
			...
			case "a": 
				start = System.currentTimeMillis();
				sortedShapes = s.selectionSort(shapes, new CompareBaseArea());
				stop = System.currentTimeMillis();
